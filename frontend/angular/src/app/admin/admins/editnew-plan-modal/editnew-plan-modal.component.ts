...
@Component({
  selector: 'app-editnew-plan-modal',
  templateUrl: './editnew-plan-modal.component.html',
  styleUrls: ['./editnew-plan-modal.component.scss']

})
export class EditnewPlanModalComponent implements OnInit {
  newForm: FormGroup;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<EditnewPlanModalComponent>,

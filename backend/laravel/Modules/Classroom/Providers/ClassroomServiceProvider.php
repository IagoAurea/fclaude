...
class ClassroomServiceProvider extends ServiceProvider
{
     ...
     */
    protected $moduleName = 'Classroom';

    /**
     * @var string $moduleNameLower
     */
    protected $moduleNameLower = 'classroom';
    ...
    public function register()
    {
        ...
        foreach ($services as $service) {
            $this->app->bind(
                "Modules\\Classroom\\Services\\Interfaces\\{$service}ServiceInterface",
                "Modules\\Classroom\\Services\\{$service}Service"
            );
        }
    }
